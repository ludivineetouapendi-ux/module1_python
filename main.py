...
# print(f"Addition: {a + b}, Type: {type(addition)}")
# print(f"Subtraction: {a - b}, Type: {type(subtraction)}")
# print(f"Multiplication: {a * b}, Type: {type(multiplication)}")
# print(f"Division: {a / b}, Type: {type(division)}")
# remainder = a % b
# power = a ** b
